...
const LOCAL_STORAGE_KEY = "socialAppUser";
    ...
    <div className="card w-[25vw] flex flex-col">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col">
          <label htmlFor="username" className="mb-[.8rem]">
            Username:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col">
          <label htmlFor="password" className="mb-[.8rem]">
            Password:
          </label>
          <input
            type="password"
        ...
        {error && <p>{error}</p>}
        <button type="submit" className="bg-[#0c1c2c] mb-[3rem]">
          Log in
        </button>
        <br></br>
        <Link to="/">Back </Link>
